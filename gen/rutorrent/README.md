# Helm chart (V3) - rutorrent

## rutorrent

[Rutorrent](https://github.com/Novik/ruTorrent) is a popular rtorrent client with a webui for ease of use.

The the docker image is part of the the [`linuxserver.io`](https://www.linuxserver.io/) collection, it has a great [documentation](https://github.com/linuxserver/docker-rutorrent) that cover all the image features.
...
```bash
helm install rutorrent rutorrent
```
